...
const EN: Dict = {
  ...
  'home.more': 'More',
  'home.less': 'Less',
  'nextAction.caughtUpTitle': "You're all caught up",
  'nextAction.caughtUpBody': 'No pending assignment, today’s challenge is done, and every unlocked level is cleared. Good time to rehearse a real visit.',
  'privacy.title': 'Your Practice Data',
  ...
  'privacy.count': '{n} saved practice records',
  'privacy.deleteAll': 'Delete my practice history',
  'privacy.confirmBody': "This permanently deletes all your roleplay and voice-partner history — scores, transcripts summaries, everything. It can't be undone.",
  'privacy.confirmYes': 'Yes, delete it all',
  'privacy.confirmCancel': 'Cancel',
  'privacy.deleted': 'Deleted. Your practice history is now empty.',
  'privacy.deleteError': "Couldn't delete — try again.",
  ...
  'assign.noteLabel': 'Reply to your manager',
  'assign.notePlaceholder': 'Add a note about this assignment…',
  'assign.noteSend': 'Send',
  'assign.noteError': "Couldn't send — try again.",
  ...
  'prep.notes': 'Notes',
  'prep.scenarioContext': 'Meeting context (optional)',
  'prep.productContext': 'Product / topic for this visit',
  'prep.productContextHint': 'e.g. "new indication launch"',
  'prep.meetingStage': 'Meeting stage',
  'prep.meetingStage.first_visit': 'First visit',
  'prep.meetingStage.follow_up': 'Follow-up',
  'prep.meetingStage.closing': 'Closing',
  'prep.availableTime': 'Time you have (minutes)',
  ...
  'prep.companyScenarios': '🏢 Company Scenarios',
  'prep.companyScenariosSubtitle': 'Drills your manager wrote and approved for your team.',
  'prep.companyScenariosEmpty': 'No company scenarios yet — check back once your manager publishes one.',
  ...
  'visit.pendingSync': 'saved offline · will sync',
  'visit.cancel': 'Cancel',
  ...
  'voice.errorMic': "Couldn't access your microphone — check permission and try again.",
  'voice.errorNetwork': "Connection problem — check your network and try again.",
  'voice.errorApi': "The AI partner didn't respond — try that again.",
  'voice.errorBadResponse': "Got an unexpected response — try that again.",
  'voice.rateLimited': "You've hit the practice limit for this hour — try again later.",
  'voice.reviewLabel': 'Listen back before sending',
  'voice.sendRecording': 'Sounds good — send it',
  'voice.rerecord': 'Re-record',
  'voice.speakerDoctor': 'Doctor',
  'voice.speakerYou': 'You',
  ...
  'voice.difficultyTitle': 'Difficulty',
  'voice.difficulty.supportive': 'Supportive — patient, low resistance',
  'voice.difficulty.realistic': 'Realistic — normal field conditions',
  'voice.difficulty.resistant': 'Resistant — sharper objections',
  'voice.difficulty.pressure_test': 'Pressure Test — time-pressed, little patience',
  'voice.deepAnalysis.button': 'View Deep Analysis',
  'voice.deepAnalysis.loading': 'Analyzing the conversation…',
  'voice.deepAnalysis.error': "Couldn't load the deep analysis right now — your session result is already saved.",
  'voice.deepAnalysis.insufficientData': 'not enough data',
  'voice.deepAnalysis.scorecardTitle': 'Scorecard',
  'voice.deepAnalysis.momentsTitle': 'Critical Moments',
  'voice.deepAnalysis.observed': 'What happened',
  'voice.deepAnalysis.missed': 'Missed opportunity',
  'voice.deepAnalysis.alternative': 'Try instead',
  'voice.competency.opening': 'Opening',
  'voice.competency.questioning': 'Questioning',
  'voice.competency.discovery': 'Discovery',
  'voice.competency.listening': 'Listening',
  'voice.competency.relevance': 'Relevance',
  'voice.competency.value_communication': 'Value communication',
  'voice.competency.evidence_use': 'Evidence use',
  'voice.competency.objection_handling': 'Objection handling',
  'voice.competency.closing': 'Closing',
  'voice.deepAnalysis.adaptationTitle': 'Adaptation',
  'voice.deepAnalysis.adaptationOverall': 'Overall adaptation score: {score}',
  ...
  'voice.adaptation.questioning': 'Questioning',
  'voice.adaptation.structure': 'Structure',
  'voice.adaptation.directness': 'Directness',
  'voice.adaptation.warmth': 'Warmth',
  ...
  'voiceOpening.durationLabel': 'Duration: {n}s (target 30–50s)',
  ...
  'voiceFab.durationLabel': 'Duration: {n}s',
  ...
  'voiceClosing.durationLabel': 'Duration: {n}s (target 30–50s)',
  ...
  'sim.entryButton': 'Text Simulation',
  'sim.title': 'Text Simulation',
  'sim.starting': 'Preparing your doctor…',
  'sim.doctor': 'Doctor',
  'sim.you': 'You',
  'sim.inputLabel': 'Your reply',
  'sim.inputPlaceholder': 'Type what you would say to the doctor…',
  'sim.send': 'Send',
  'sim.sending': 'Doctor is replying…',
  'sim.end': 'End Simulation',
  'sim.ending': 'Analyzing your conversation…',
  'sim.back': 'Back',
  'sim.repTurns': '{n} messages sent',
  'sim.retry': 'Try again',
  'sim.error.not_configured': 'Text simulation isn’t available right now.',
  'sim.error.rate_limited': 'Too many requests — try again in a few minutes.',
  'sim.error.unavailable': 'The AI service didn’t respond. Try again.',
  'sim.error.no_rep_turns': 'Send at least one message before ending the simulation.',
  'sim.error.turn_limit': 'You’ve reached the message limit — end the simulation to see your report.',
  'sim.error.generic': 'Something went wrong. Try again.',
  'sim.report.title': 'Simulation Report',
  'sim.report.overall': 'Overall',
  'sim.report.competencies': 'Competency scores',
  'sim.report.noEvidence': 'Not enough evidence',
  'sim.report.strongest': 'Strongest behavior',
  'sim.report.opportunity': 'Biggest development opportunity',
  'sim.report.none': 'Nothing identified in this conversation.',
  'sim.report.observations': 'Behavioral observations',
  'sim.report.evidence': 'Transcript evidence',
  'sim.report.turn': 'Turn {n}',
  'sim.report.coaching': 'Coaching recommendation',
  'sim.report.whatHappened': 'What happened',
  'sim.report.whyItMattered': 'Why it mattered',
  'sim.report.doDifferently': 'What to do differently',
  'sim.report.betterExample': 'Better example response',
  'sim.report.practice': 'Practice action',
  'sim.report.buildOn': 'Building on a strength',
  'sim.report.coachingUnavailable': 'Coaching couldn’t be generated this time. Your scores and observations are above.',
  'sim.report.retryCoaching': 'Retry coaching',
  'sim.report.nothingToCoach': 'No coaching points this time.',
  'sim.report.tryAgain': 'Try Again',
  'sim.report.transcript': 'Full transcript',
  'sim.report.dir.positive': 'Helped',
  'sim.report.dir.negative': 'Hurt',
  'sim.report.dir.neutral': 'Neutral',
  ...
  'report.voiceMeasurements.title': 'Voice measurements',
  'report.voiceMeasurements.metric.speaking_share': 'Speaking share',
  'report.voiceMeasurements.metric.speaking_rate': 'Speaking rate',
  'report.voiceMeasurements.metric.pitch_variation': 'Pitch variation',
  'report.voiceMeasurements.metric.pauses': 'Pauses',
  'report.voiceMeasurements.metric.rapid_turn_switches': 'Rapid turn switches',
  'report.voiceMeasurements.metric.question_frequency': 'Question frequency',
  'report.voiceMeasurements.metric.open_question_ratio': 'Open-question ratio',
  ...
  'report.evidence.play': 'Play recording',
  'sim.comp.questioning': 'Questioning',
  'sim.comp.active_listening': 'Active listening',
  'sim.comp.discovery': 'Discovery',
  'sim.comp.communication_clarity': 'Communication clarity',
  'sim.comp.adaptation': 'Adaptation',
  'sim.comp.objection_handling': 'Objection handling',
  'sim.comp.value_communication': 'Value communication',
  'sim.comp.closing': 'Closing',
  'sim.beh.open_question': 'Open question',
  'sim.beh.leading_question': 'Leading question',
  'sim.beh.paraphrasing': 'Paraphrasing the doctor',
  'sim.beh.empathy_statement': 'Empathy statement',
  'sim.beh.interruption': 'Interrupting',
  'sim.beh.clarification': 'Asking for clarification',
  'sim.beh.need_uncovered': 'Uncovering a need',
  'sim.beh.premature_pitch': 'Pitching too early',
  'sim.beh.style_matched': 'Matching the doctor’s style',
  'sim.beh.adjusted_to_reaction': 'Adjusting to the doctor’s reaction',
  'sim.beh.style_mismatch': 'Mismatch with the doctor’s style',
  'sim.beh.objection_acknowledged': 'Acknowledging the objection',
  'sim.beh.evidence_referenced': 'Referencing evidence',
  'sim.beh.resolution_checked': 'Checking the concern was resolved',
  'sim.beh.ignored_objection': 'Ignoring the objection',
  'sim.beh.argued_with_doctor': 'Arguing with the doctor',
  'sim.beh.benefit_tied_to_need': 'Tying the benefit to the doctor’s need',
  'sim.beh.generic_claim': 'Generic claim',
  'sim.beh.unsupported_claim': 'Claim without evidence',
  'sim.beh.next_step_proposed': 'Proposing a next step',
  'sim.beh.summarized': 'Summarizing',
  'sim.beh.no_next_step': 'Ending with no next step',
  ...
  'join.pinPlaceholder': 'Choose a 6-digit PIN',
  'join.pinHint': "You'll use this PIN with your mobile number to log in next time — don't share it.",
  'join.submit': 'Join Team →',
  'join.loading': 'Joining…',
  'join.hint': 'Your mobile number and PIN are your login — no email needed.',
  'join.alreadyHaveAccount': 'Already have an account? Log in',
  ...
  'roleplay.interactionSummaryTitle': 'What Happened',
  'roleplay.interactionSummaryDuration': 'This conversation ran {mmss}.',
  'roleplay.interactionSummaryQuestions': 'You asked {count} question(s).',
  'roleplay.interactionSummaryToneMatch': "Your tone (pace, pitch, pauses) matched your partner's by {pct}%.",
  'roleplay.interactionSummaryTermOverlap': 'You shared {pct}% of the same key words and phrases — a rapport signal.',
  'roleplay.lowSampleWarning': "This conversation was short — treat these percentages as a rough read, not a precise score.",
  ...
  'roleplay.tonalityTitle': 'Tonality',
  'roleplay.tonalityDetail': '{wpm} words/min · {hesitations} hesitations detected',
  'roleplay.pace.slow': 'Slow pace',
  'roleplay.pace.measured': 'Measured pace',
  'roleplay.pace.fast': 'Fast pace',
  'roleplay.pace.rapid': 'Rapid pace',
  'roleplay.hesitation.fluent': 'Fluent',
  'roleplay.hesitation.mild': 'Mild hesitation',
  'roleplay.hesitation.moderate': 'Moderate hesitation',
  'roleplay.hesitation.frequent': 'Frequent hesitation',
  'roleplay.range.flat': 'Flat tone',
  'roleplay.range.moderate': 'Moderate range',
  'roleplay.range.expressive': 'Expressive tone',
  'roleplay.rapportTitle': 'Rapport in tone',
  'roleplay.rapportHint': 'How much warmth language (thanks, appreciate, please, glad, together...) showed up in what you said — a proxy for tone, not a measure of sincerity.',
  'roleplay.dominantWording': 'Key wording leaned',
  'roleplay.predicate.visual': 'visual ("see", "picture", "show")',
  'roleplay.predicate.auditory': 'auditory ("hear", "tell", "sounds like")',
  'roleplay.predicate.kinesthetic': 'kinesthetic ("feel", "handle", "comfortable")',
  'roleplay.done': 'Done',
  'roleplay.shareWithManager': 'Share with manager',
  'roleplay.shared': 'Shared with your manager',
  'roleplay.shareError': "Couldn't share — try again",
  'roleplay.errorMic': 'Microphone access is needed to record a roleplay. Check your browser permissions and try again.',
  'roleplay.errorDiarize': 'Analysis failed. Your recording is still available below; retry to continue.',
  'roleplay.retryAnalysis': 'Retry analysis',
  'roleplay.saveRecording': 'Save recording',
  'roleplay.errorTimeout': 'Analysis is taking longer than expected. Retry to continue processing the same recording.',
  'roleplay.errorTooLarge': 'This recording is too large to upload. Save it below, then try a shorter recording.',
  'roleplay.errorSave': 'Your report is ready, but it could not be saved to your history.',
  'roleplay.errorSession': 'Your session expired. Sign in again, then start the roleplay recording.',
  'roleplay.errorSpeakers': "We could only make out one voice in the recording. Make sure both of you speak clearly, hold the phone between you, and record for at least 30 seconds — then try again.",
  'roleplay.pickDifferentSpeaker': 'Wrong speaker? Choose again',
  'roleplay.recordAnother': 'Record another roleplay',
  'roleplay.adaptationTitle': 'Style Adaptation',
  'roleplay.adaptationYouVsPartner': 'You ({you}) vs. partner ({partner})',
  'roleplay.adaptationLabel.mirrored': "You closely matched your practice partner's style — strong adaptation.",
  'roleplay.adaptationLabel.aligned': "You partially matched your practice partner's style — some adaptation.",
  'roleplay.adaptationLabel.mismatched': "Your style and your practice partner's stayed far apart — room to adapt more.",
  'roleplay.noAdaptationRead': "Not enough of your practice partner's speech to read their style and compare.",
  'roleplay.insightTitle': "Coach's Tip",
  'roleplay.insight.talkRatio': "You held the floor {value}% of the time — aim closer to 50/50. Ask a question and let your partner respond before continuing.",
  'roleplay.insight.adaptationScore': "Your style matched your practice partner's only {value}%. Notice their pace and tone, and shift yours to meet them.",
  'roleplay.insight.questionRatio': "Only {value}% of your turns were questions. Ask more — it keeps your partner engaged and gives you more to work with.",
  'roleplay.insight.openQuestionRatio': 'Only {value}% of your questions were open-ended. Swap a few yes/no questions for "what" or "how" ones to draw out more detail.',
  'roleplay.insight.paraphraseScore': "You rarely echoed back what your partner said ({value}%). Reflect their words before replying — it shows you're listening.",
  'roleplay.insight.activeListening': 'Active listening scored {value}/100. Balance your talk time, avoid cutting in, and paraphrase more.',
  'roleplay.insight.rapidSwitches': "You had about {value} rapid back-and-forth switches per minute — that can read as interrupting. Let your partner finish before you respond.",
  ...
  'bias.title': 'Likely bias at play',
  'bias.cueLabel': 'How to spot it',
  'bias.tacticLabel': 'What to do',
  'bias.confirmation_bias.name': 'Confirmation bias',
  'bias.confirmation_bias.cue': 'They accept only evidence that confirms what they already believe, and wave off anything that contradicts it without really engaging it.',
  'bias.confirmation_bias.tactic': "Don't open with your strongest counter-evidence. Ask what evidence would actually change their mind first, then match your data to that.",
  'bias.anchoring_bias.name': 'Anchoring bias',
  'bias.anchoring_bias.cue': "They're fixated on one reference number (a generic price, a first quote) and judge everything against it.",
  'bias.anchoring_bias.tactic': 'Move the anchor before you argue the number — talk total cost of care or outcome-per-cost before any price comparison.',
  'bias.availability_bias.name': 'Availability bias',
  'bias.availability_bias.cue': 'One vivid or recent case — a bad outcome, a scary story — is driving the objection more than the actual incidence data.',
  'bias.availability_bias.tactic': "Acknowledge that specific case by name before you argue data — they need to feel heard first — then place it against the real base rate.",
  'bias.social_proof_bias.name': 'Social proof bias',
  'bias.social_proof_bias.cue': "They're citing what other doctors, KOLs, or the market are doing rather than evaluating the product on its own merits.",
  'bias.social_proof_bias.tactic': "Don't attack who they're following. Give them a reason to be early among peers, not the odd one out.",
  'bias.status_quo_bias.name': 'Status quo bias',
  'bias.status_quo_bias.cue': "The objection is really about switching effort (\"too busy\", \"no time\") — the current routine is just easier, not genuinely better.",
  'bias.status_quo_bias.tactic': 'Shrink the switching cost explicitly — offer the smallest possible first step, not the full protocol change.',
  'bias.authority_bias.name': 'Authority bias',
  'bias.authority_bias.cue': 'They defer to a panel, institution, or protocol instead of forming an independent judgment on what you pitched.',
  'bias.authority_bias.tactic': 'Find the authority figure who already agrees and lead with them — an internal champion outweighs an external argument.',
  'bias.negativity_bias.name': 'Negativity bias',
  'bias.negativity_bias.cue': 'One bad delivery or stock experience is coloring their view of the entire product, out of proportion to how rare it actually was.',
  'bias.negativity_bias.tactic': "Name the specific failure and the concrete fix before pivoting back to the product's merits — don't paper over it.",
...
const AR: Dict = {
  ...
  'home.more': 'المزيد',
  'home.less': 'أقل',
  'nextAction.caughtUpTitle': 'أنجزت كل شيء',
  'nextAction.caughtUpBody': 'لا مهمة معلقة، وتحدي اليوم مكتمل، وكل مستوى مفتوح تم اجتيازه. وقت جيد لتتدرّب على زيارة حقيقية.',
  'privacy.title': 'بيانات تدريبك',
  'privacy.body': 'يتم تحليل التسجيلات التدريبية ثم يُحذف الصوت نفسه فور المعالجة، إلا إذا اخترت صراحةً الاحتفاظ به لتسجيل زيارة عميل حقيقي — في هذه الحالة يُحفظ بأمان ضمن حسابك حتى تحذفه أنت أو تنتهي مدة الاحتفاظ التي اخترتها.',
  'privacy.count': '{n} سجل تدريب محفوظ',
  'privacy.deleteAll': 'احذف سجل تدريبي',
  'privacy.confirmBody': 'سيؤدي هذا إلى حذف كل سجل تدريبك الصوتي ولعب الأدوار نهائياً — النتائج، ملخصات النصوص، كل شيء. لا يمكن التراجع عن هذا.',
  'privacy.confirmYes': 'نعم، احذف كل شيء',
  'privacy.confirmCancel': 'إلغاء',
  'privacy.deleted': 'تم الحذف. سجل تدريبك فارغ الآن.',
  'privacy.deleteError': 'تعذر الحذف — حاول مرة أخرى.',
  ...
  'nav.tabsLabel': 'الأقسام الرئيسية',
  ...
  'group.backToGame': '← العودة إلى اللعبة',
  ...
  'assign.noteLabel': 'رد على مديرك',
  'assign.notePlaceholder': 'أضف ملاحظة حول هذه المهمة…',
  'assign.noteSend': 'إرسال',
  'assign.noteError': 'تعذر الإرسال — حاول مرة أخرى.',
  // team ranking (rep-facing)
  ...
  'prep.notes': 'ملاحظات',
  'prep.scenarioContext': 'سياق الزيارة (اختياري)',
  'prep.productContext': 'المنتج / الموضوع لهذه الزيارة',
  'prep.productContextHint': 'مثال: «إطلاق استطباب جديد»',
  'prep.meetingStage': 'مرحلة الزيارة',
  'prep.meetingStage.first_visit': 'أول زيارة',
  'prep.meetingStage.follow_up': 'متابعة',
  'prep.meetingStage.closing': 'إغلاق',
  'prep.availableTime': 'الوقت المتاح (دقائق)',
  ...
  'prep.companyScenarios': '🏢 سيناريوهات الشركة',
  'prep.companyScenariosSubtitle': 'تمارين كتبها مديرك واعتمدها لفريقك.',
  'prep.companyScenariosEmpty': 'لا توجد سيناريوهات شركة بعد — تحقق لاحقًا بعد أن ينشر مديرك واحدًا.',
  ...
  'visit.pendingSync': 'محفوظ دون اتصال · سيُزامَن',
  'visit.cancel': 'إلغاء',
  ...
  'voice.errorMic': 'تعذر الوصول إلى الميكروفون — تحقق من الإذن وحاول مرة أخرى.',
  'voice.errorNetwork': 'مشكلة في الاتصال — تحقق من الشبكة وحاول مرة أخرى.',
  'voice.errorApi': 'لم يستجب الشريك الذكي — حاول مرة أخرى.',
  'voice.errorBadResponse': 'استجابة غير متوقعة — حاول مرة أخرى.',
  'voice.rateLimited': 'لقد وصلت إلى حد التدريب لهذه الساعة — حاول مرة أخرى لاحقاً.',
  'voice.reviewLabel': 'استمع قبل الإرسال',
  'voice.sendRecording': 'جيد — أرسلها',
  'voice.rerecord': 'أعد التسجيل',
  'voice.speakerDoctor': 'الطبيب',
  'voice.speakerYou': 'أنت',
  ...
  'voice.difficultyTitle': 'مستوى الصعوبة',
  'voice.difficulty.supportive': 'داعم — متسامح، مقاومة أقل',
  'voice.difficulty.realistic': 'واقعي — ظروف ميدانية عادية',
  'voice.difficulty.resistant': 'مقاوم — اعتراضات أقوى',
  'voice.difficulty.pressure_test': 'اختبار ضغط — وقت ضيّق وصبر قليل',
  'voice.deepAnalysis.button': 'عرض التحليل المتعمق',
  'voice.deepAnalysis.loading': 'جارٍ تحليل المحادثة…',
  'voice.deepAnalysis.error': 'تعذّر تحميل التحليل المتعمق الآن — نتيجة الجلسة محفوظة بالفعل.',
  'voice.deepAnalysis.insufficientData': 'بيانات غير كافية',
  'voice.deepAnalysis.scorecardTitle': 'بطاقة الأداء',
  'voice.deepAnalysis.momentsTitle': 'اللحظات الحاسمة',
  'voice.deepAnalysis.observed': 'ما حدث',
  'voice.deepAnalysis.missed': 'فرصة فائتة',
  'voice.deepAnalysis.alternative': 'جرّب بدلاً من ذلك',
  'voice.competency.opening': 'الافتتاح',
  'voice.competency.questioning': 'طرح الأسئلة',
  'voice.competency.discovery': 'الاستكشاف',
  'voice.competency.listening': 'الإصغاء',
  'voice.competency.relevance': 'الملاءمة',
  'voice.competency.value_communication': 'إيصال القيمة',
  'voice.competency.evidence_use': 'استخدام الأدلة',
  'voice.competency.objection_handling': 'التعامل مع الاعتراضات',
  'voice.competency.closing': 'الإغلاق',
  'voice.deepAnalysis.adaptationTitle': 'التكيّف',
  'voice.deepAnalysis.adaptationOverall': 'درجة التكيّف الإجمالية: {score}',
  ...
  'voice.adaptation.questioning': 'طرح الأسئلة',
  'voice.adaptation.structure': 'التنظيم',
  'voice.adaptation.directness': 'المباشرة',
  'voice.adaptation.warmth': 'الدفء',
  ...
  'voiceOpening.durationLabel': 'المدة: {n} ثانية (الهدف 30–50 ثانية)',
  ...
  'voiceFab.durationLabel': 'المدة: {n} ثانية',
  ...
  'voiceClosing.durationLabel': 'المدة: {n} ثانية (الهدف 30–50 ثانية)',
  ...
  'sim.entryButton': 'محاكاة نصية',
  'sim.title': 'محاكاة نصية',
  'sim.starting': 'جارٍ تجهيز الطبيب…',
  'sim.doctor': 'الطبيب',
  'sim.you': 'أنت',
  'sim.inputLabel': 'ردّك',
  'sim.inputPlaceholder': 'اكتب ما ستقوله للطبيب…',
  'sim.send': 'إرسال',
  'sim.sending': 'الطبيب يردّ…',
  'sim.end': 'إنهاء المحاكاة',
  'sim.ending': 'جارٍ تحليل محادثتك…',
  'sim.back': 'رجوع',
  'sim.repTurns': 'عدد الرسائل المرسلة: {n}',
  'sim.retry': 'إعادة المحاولة',
  'sim.error.not_configured': 'المحاكاة النصية غير متاحة حالياً.',
  'sim.error.rate_limited': 'طلبات كثيرة — حاول مجدداً بعد دقائق.',
  'sim.error.unavailable': 'لم تستجب خدمة الذكاء الاصطناعي. حاول مرة أخرى.',
  'sim.error.no_rep_turns': 'أرسل رسالة واحدة على الأقل قبل إنهاء المحاكاة.',
  'sim.error.turn_limit': 'وصلت إلى الحد الأقصى للرسائل — أنهِ المحاكاة لعرض تقريرك.',
  'sim.error.generic': 'حدث خطأ ما. حاول مرة أخرى.',
  'sim.report.title': 'تقرير المحاكاة',
  'sim.report.overall': 'الإجمالي',
  'sim.report.competencies': 'درجات الكفاءات',
  'sim.report.noEvidence': 'أدلة غير كافية',
  'sim.report.strongest': 'أقوى سلوك',
  'sim.report.opportunity': 'أكبر فرصة للتطوير',
  'sim.report.none': 'لم يُرصد شيء في هذه المحادثة.',
  'sim.report.observations': 'الملاحظات السلوكية',
  'sim.report.evidence': 'دليل من المحادثة',
  'sim.report.turn': 'الدور {n}',
  'sim.report.coaching': 'توصية التدريب',
  'sim.report.whatHappened': 'ما الذي حدث',
  'sim.report.whyItMattered': 'لماذا كان مهماً',
  'sim.report.doDifferently': 'ماذا تفعل بشكل مختلف',
  'sim.report.betterExample': 'مثال لرد أفضل',
  'sim.report.practice': 'تمرين عملي',
  'sim.report.buildOn': 'البناء على نقطة قوة',
  'sim.report.coachingUnavailable': 'تعذّر إنشاء التوصيات هذه المرة. درجاتك وملاحظاتك أعلاه.',
  'sim.report.retryCoaching': 'إعادة توليد التوصيات',
  'sim.report.nothingToCoach': 'لا توجد نقاط تدريب هذه المرة.',
  'sim.report.tryAgain': 'حاول مرة أخرى',
  'sim.report.transcript': 'المحادثة الكاملة',
  'sim.report.dir.positive': 'ساعد',
  'sim.report.dir.negative': 'أضرّ',
  'sim.report.dir.neutral': 'محايد',
  ...
  'report.objectiveStatus.achieved': 'تم تحقيقه',
  'report.objectiveStatus.partial': 'تحقق جزئياً',
  'report.objectiveStatus.not_achieved': 'لم يتحقق',
  'report.objectiveStatus.insufficient_evidence': 'الأدلة غير كافية للحكم',
  'report.customerUnderstanding.title': 'ما كان يهم العميل',
  'report.customerUnderstanding.needs': 'الاحتياجات',
  'report.customerUnderstanding.concerns': 'المخاوف',
  'report.customerUnderstanding.decisionCriteria': 'معايير القرار',
  'report.customerUnderstanding.openQuestions': 'أسئلة ما زالت بلا إجابة',
  'report.certainty.stated': 'ذكره العميل مباشرة',
  'report.certainty.inferred': 'تفسير محتمل',
  'report.certainty.not_established': 'غير مؤكد',
  'report.performance.title': 'كيف تعامل المندوب',
  'report.performance.whyItMattered': 'لماذا كان مهماً',
  'report.performance.improvement': 'شيء واحد يمكن تجربته',
  'report.performance.dimension.opening': 'الافتتاحية',
  'report.performance.dimension.questioning': 'طرح الأسئلة',
  'report.performance.dimension.listening': 'الإصغاء',
  'report.performance.dimension.value_linking': 'ربط القيمة بالاحتياجات',
  'report.performance.dimension.evidence_use': 'استخدام الأدلة',
  'report.performance.dimension.objection_handling': 'التعامل مع الاعتراضات',
  'report.performance.dimension.adaptation': 'التكيّف مع العميل',
  'report.performance.dimension.closing': 'الإغلاق',
  'report.criticalMoments.title': 'اللحظات الحاسمة',
  'report.criticalMoments.better': 'كان يمكن أن يكون الرد الأفضل',
  'report.voiceMeasurements.title': 'قياسات الصوت',
  'report.voiceMeasurements.metric.speaking_share': 'نسبة الحديث',
  'report.voiceMeasurements.metric.speaking_rate': 'سرعة الحديث',
  'report.voiceMeasurements.metric.pitch_variation': 'تنوّع نبرة الصوت',
  'report.voiceMeasurements.metric.pauses': 'فترات الصمت',
  'report.voiceMeasurements.metric.rapid_turn_switches': 'تبادل الحديث السريع',
  'report.voiceMeasurements.metric.question_frequency': 'تكرار الأسئلة',
  'report.voiceMeasurements.metric.open_question_ratio': 'نسبة الأسئلة المفتوحة',
  'report.commitments.title': 'ما تم الاتفاق عليه',
  'report.commitments.status.agreed': 'متفق عليه',
  'report.commitments.status.proposed': 'مقترح، لم يُقبل بعد',
  'report.commitments.status.ai_recommended': 'متابعة مقترحة',
  'report.coachingPriority.title': 'سلوك واحد للتدرب عليه',
  'report.coachingPriority.betterPhrase': 'جرّب أن تقول',
  'report.coachingPriority.practice': 'تمرين للممارسة',
  'report.coachingPriority.success': 'شكل النجاح في المرة القادمة',
  'report.strength.title': 'استمر في فعل هذا',
  'report.socialStyle.title': 'أسلوب التواصل',
  'report.socialStyle.subject.customer': 'العميل',
  'report.socialStyle.subject.rep': 'المندوب',
  'report.socialStyle.style.driver': 'مباشر ومركّز على النتائج',
  'report.socialStyle.style.expressive': 'متحمس ويرى الصورة الكبيرة',
  'report.socialStyle.style.amiable': 'يركّز على العلاقة ومتزن',
  'report.socialStyle.style.analytical': 'يهتم بالتفاصيل وحذر',
  'report.socialStyle.insufficientEvidence': 'لا توجد أدلة كافية في هذه المحادثة لوصف أسلوب معيّن.',
  'report.socialStyle.configuredNotDiscovered': 'إعداد للمحاكاة، وليس شيئاً تم اكتشافه من المحادثة',
  'report.socialStyle.simulationNote': 'هذه المحادثة كانت محاكاة — أسلوب الطبيب كان مُعدّاً مسبقاً وليس ملاحظاً من عميل حقيقي.',
  'report.socialStyle.alternative': 'تفسير بديل',
  'report.socialStyle.driftFrom': 'إشارات هذه الجلسة تختلف عن الملف المسجل سابقاً لـ',
  'report.socialStyle.profileDrift': 'إشارات هذه الجلسة تختلف عن الملف المحفوظ — يستحق نظرة ثانية.',
  'report.socialStyle.adaptation': 'كيف تكيّف المندوب',
  'report.socialStyle.assessment.well_adapted': 'تكيّف جيداً',
  'report.socialStyle.assessment.mismatched': 'غير متوافق',
  'report.socialStyle.assessment.insufficient_evidence': 'أدلة غير كافية',
  'report.socialStyle.observedSignals': 'الإشارات الملاحظة',
  'report.socialStyle.possiblePreference': 'التفضيل المحتمل',
  'report.socialStyle.evidenceAndAlternative': 'الأدلة والتفسير البديل',
  'report.socialStyle.repResponse': 'كيف تعامل المندوب',
  'report.socialStyle.adjustment': 'أكثر تعديل مفيد',
  'report.socialStyle.wording': 'صياغة مقترحة للزيارة القادمة',
  'report.evidence.play': 'تشغيل التسجيل',
  'sim.comp.questioning': 'طرح الأسئلة',
  'sim.comp.active_listening': 'الإصغاء الفعّال',
  'sim.comp.discovery': 'استكشاف الاحتياج',
  'sim.comp.communication_clarity': 'وضوح التواصل',
  'sim.comp.adaptation': 'التكيّف',
  'sim.comp.objection_handling': 'التعامل مع الاعتراضات',
  'sim.comp.value_communication': 'إيصال القيمة',
  'sim.comp.closing': 'الإغلاق',
  'sim.beh.open_question': 'سؤال مفتوح',
  'sim.beh.leading_question': 'سؤال إيحائي',
  'sim.beh.paraphrasing': 'إعادة صياغة كلام الطبيب',
  'sim.beh.empathy_statement': 'عبارة تعاطف',
  'sim.beh.interruption': 'مقاطعة',
  'sim.beh.clarification': 'طلب توضيح',
  'sim.beh.need_uncovered': 'كشف احتياج',
  'sim.beh.premature_pitch': 'عرض مبكّر للمنتج',
  'sim.beh.style_matched': 'مطابقة أسلوب الطبيب',
  'sim.beh.adjusted_to_reaction': 'التعديل بحسب ردّ فعل الطبيب',
  'sim.beh.style_mismatch': 'عدم توافق مع أسلوب الطبيب',
  'sim.beh.objection_acknowledged': 'الاعتراف بالاعتراض',
  'sim.beh.evidence_referenced': 'الاستناد إلى دليل',
  'sim.beh.resolution_checked': 'التحقق من حلّ الاعتراض',
  'sim.beh.ignored_objection': 'تجاهل الاعتراض',
  'sim.beh.argued_with_doctor': 'مجادلة الطبيب',
  'sim.beh.benefit_tied_to_need': 'ربط الفائدة باحتياج الطبيب',
  'sim.beh.generic_claim': 'ادّعاء عام',
  'sim.beh.unsupported_claim': 'ادّعاء بلا دليل',
  'sim.beh.next_step_proposed': 'اقتراح خطوة تالية',
  'sim.beh.summarized': 'تلخيص',
  'sim.beh.no_next_step': 'إنهاء بلا خطوة تالية',
  ...
  'login.pinLabel': 'الرمز السري',
  'login.pinPlaceholder': 'رمز سري من 6 أرقام',
  ...
  'join.pinPlaceholder': 'اختر رمزاً سرياً من 6 أرقام',
  'join.pinHint': 'ستستخدم هذا الرمز مع رقم جوالك لتسجيل الدخول لاحقاً — لا تشاركه مع أحد.',
  'join.submit': 'انضم للفريق ←',
  'join.loading': 'جارٍ الانضمام…',
  'join.hint': 'رقم جوالك ورمزك السري هما بيانات دخولك — لا حاجة لبريد إلكتروني.',
  'join.alreadyHaveAccount': 'لديك حساب بالفعل؟ سجّل الدخول',
  ...
  'roleplay.interactionSummaryTitle': 'ماذا حدث',
  'roleplay.interactionSummaryDuration': 'استمرت هذه المحادثة {mmss}.',
  'roleplay.interactionSummaryQuestions': 'طرحت {count} سؤال (أسئلة).',
  'roleplay.interactionSummaryToneMatch': 'تطابقت نبرة صوتك (السرعة، طبقة الصوت، التوقفات) مع شريكك بنسبة {pct}٪.',
  'roleplay.interactionSummaryTermOverlap': 'شاركت {pct}٪ من نفس الكلمات والعبارات الرئيسية — إشارة على الانسجام.',
  'roleplay.lowSampleWarning': 'كانت هذه المحادثة قصيرة — اعتبر هذه النسب تقديراً تقريبياً وليست دقيقة.',
  ...
  'roleplay.tonalityTitle': 'نبرة الصوت',
  'roleplay.tonalityDetail': '{wpm} كلمة/دقيقة · {hesitations} توقفات متردّدة',
  'roleplay.pace.slow': 'إيقاع بطيء',
  'roleplay.pace.measured': 'إيقاع متزن',
  'roleplay.pace.fast': 'إيقاع سريع',
  'roleplay.pace.rapid': 'إيقاع سريع جدًا',
  'roleplay.hesitation.fluent': 'طليق',
  'roleplay.hesitation.mild': 'تردّد خفيف',
  'roleplay.hesitation.moderate': 'تردّد متوسط',
  'roleplay.hesitation.frequent': 'تردّد متكرر',
  'roleplay.range.flat': 'نبرة ثابتة',
  'roleplay.range.moderate': 'نطاق متوسط',
  'roleplay.range.expressive': 'نبرة معبّرة',
  'roleplay.rapportTitle': 'الألفة في النبرة',
  'roleplay.rapportHint': 'مدى ظهور كلمات الدفء (شكرًا، أقدّر، من فضلك، سعيد، معًا...) فيما قلته — مؤشر على النبرة، وليس مقياسًا للصدق.',
  'roleplay.dominantWording': 'اتجهت لغتك نحو',
  'roleplay.predicate.visual': 'بصري ("أشوف"، "واضح"، "يبيّن")',
  'roleplay.predicate.auditory': 'سمعي ("أسمع"، "يحكي"، "نتفاهم")',
  'roleplay.predicate.kinesthetic': 'حسّي ("أحس"، "مريح"، "ثقيل")',
  'roleplay.done': 'تم',
  'roleplay.shareWithManager': 'شارك مع مديرك',
  'roleplay.shared': 'تمت المشاركة مع مديرك',
  'roleplay.shareError': 'تعذرت المشاركة — حاول مرة أخرى',
  'roleplay.errorMic': 'يلزم الوصول إلى الميكروفون لتسجيل تمرين تمثيل الأدوار. تحقق من أذونات المتصفح وحاول مجدداً.',
  'roleplay.errorDiarize': 'فشل التحليل. تسجيلك لا يزال متاحاً أدناه؛ أعد المحاولة للمتابعة.',
  'roleplay.retryAnalysis': 'إعادة المحاولة',
  'roleplay.saveRecording': 'حفظ التسجيل',
  'roleplay.errorTimeout': 'يستغرق التحليل وقتاً أطول من المتوقع. أعد المحاولة لمتابعة معالجة التسجيل نفسه.',
  'roleplay.errorTooLarge': 'هذا التسجيل كبير جداً للرفع. احفظه أدناه، ثم جرّب تسجيلاً أقصر.',
  'roleplay.errorSave': 'تقريرك جاهز، لكن تعذّر حفظه في سجلّك.',
  'roleplay.errorSession': 'انتهت صلاحية جلستك. سجّل الدخول من جديد، ثم ابدأ تسجيل تمرين تمثيل الأدوار.',
  'roleplay.errorSpeakers': 'تمكّنّا من تمييز صوت واحد فقط في التسجيل. تأكّدا من أن كليكما يتحدث بوضوح، وضع الهاتف بينكما، وسجّلا لمدة 30 ثانية على الأقل — ثم حاول مجدداً.',
  'roleplay.pickDifferentSpeaker': 'المتحدث غير صحيح؟ اختر مجدداً',
  'roleplay.recordAnother': 'سجّل تمرين تمثيل أدوار آخر',
  'roleplay.adaptationTitle': 'التكيّف مع الأسلوب',
  'roleplay.adaptationYouVsPartner': 'أنت ({you}) مقابل الشريك ({partner})',
  'roleplay.adaptationLabel.mirrored': 'تطابق أسلوبك بشكل كبير مع أسلوب شريك التمرين — تكيّف قوي.',
  'roleplay.adaptationLabel.aligned': 'تطابق أسلوبك جزئياً مع أسلوب شريك التمرين — تكيّف متوسط.',
  'roleplay.adaptationLabel.mismatched': 'ظلّ أسلوبك بعيداً عن أسلوب شريك التمرين — هناك مجال أكبر للتكيّف.',
  'roleplay.noAdaptationRead': 'لا يوجد كلام كافٍ من شريك التمرين لقراءة أسلوبه ومقارنته.',
  'roleplay.insightTitle': 'نصيحة المدرّب',
  'roleplay.insight.talkRatio': 'تحدّثت {value}% من الوقت — اقترب أكثر من نسبة 50/50. اطرح سؤالاً ودع شريكك يجيب قبل أن تكمل.',
  'roleplay.insight.adaptationScore': 'تطابق أسلوبك مع شريك التمرين بنسبة {value}% فقط. لاحظ وتيرته ونبرته، وعدّل أسلوبك ليتناسب معه.',
  'roleplay.insight.questionRatio': '{value}% فقط من جولاتك كانت أسئلة. اطرح أسئلة أكثر — هذا يبقي شريكك منخرطاً ويمنحك معلومات أكثر للعمل عليها.',
  'roleplay.insight.openQuestionRatio': '{value}% فقط من أسئلتك كانت مفتوحة. استبدل بعض أسئلة نعم/لا بأسئلة "ماذا" أو "كيف" لاستخراج تفاصيل أكثر.',
  'roleplay.insight.paraphraseScore': 'نادراً ما أعدت صياغة ما قاله شريكك ({value}%). اعكس كلماته قبل أن تجيب — هذا يُظهر أنك تستمع فعلاً.',
  'roleplay.insight.activeListening': 'سجّل الاستماع الفعّال {value}/100. وازن وقت حديثك، تجنّب المقاطعة، وأعد الصياغة أكثر.',
  'roleplay.insight.rapidSwitches': 'كان لديك نحو {value} تبديلات سريعة في الحديث بالدقيقة — قد يُفهم هذا كمقاطعة. دع شريكك ينهي كلامه قبل أن تجيب.',
  ...
  'bias.tacticLabel': 'ماذا تفعل',
  'bias.confirmation_bias.name': 'تحيّز التأكيد',
  'bias.confirmation_bias.cue': 'يقبل الطبيب فقط الأدلة التي تؤكد ما يعتقده مسبقًا، ويتجاهل أي دليل يخالفه دون النظر فيه فعليًا.',
  'bias.confirmation_bias.tactic': 'لا تبدأ بأقوى دليل مضاد لديك. اسأله أولًا ما الدليل الذي قد يغيّر رأيه، ثم قدّم بياناتك بما يطابق ذلك المعيار.',
  'bias.anchoring_bias.name': 'تحيّز التثبيت (المرساة)',
  'bias.anchoring_bias.cue': 'الطبيب متمسك برقم مرجعي واحد (سعر الدواء الجنيس، أول عرض سمعه) ويقيس كل شيء بناءً عليه.',
  'bias.anchoring_bias.tactic': 'غيّر المرساة قبل مناقشة الرقم — تحدّث عن التكلفة الإجمالية للرعاية أو النتيجة مقابل التكلفة قبل أي مقارنة أسعار.',
  'bias.availability_bias.name': 'تحيّز التوفر',
  'bias.availability_bias.cue': 'حالة واحدة حديثة أو مؤثرة — نتيجة سيئة، قصة مخيفة — تقود الاعتراض أكثر من بيانات معدل الحدوث الفعلي.',
  'bias.availability_bias.tactic': 'اعترف بتلك الحالة تحديدًا قبل مناقشة البيانات — يحتاج أن يشعر أنك سمعته أولًا — ثم ضعها في سياق المعدل الحقيقي.',
  'bias.social_proof_bias.name': 'تحيّز الإثبات الاجتماعي',
  'bias.social_proof_bias.cue': 'يستشهد الطبيب بما يفعله أطباء آخرون أو قادة الرأي أو السوق بدلاً من تقييم المنتج بمفرده.',
  'bias.social_proof_bias.tactic': 'لا تهاجم من يتبعهم. أعطه سببًا ليكون من الأوائل بين أقرانه، لا الاستثناء المتأخر.',
  'bias.status_quo_bias.name': 'تحيّز الوضع الراهن',
  'bias.status_quo_bias.cue': 'الاعتراض في جوهره عن جهد التغيير ("مشغول"، "لا وقت") — الروتين الحالي أسهل فقط، وليس أفضل فعليًا.',
  'bias.status_quo_bias.tactic': 'قلّل تكلفة التغيير بوضوح — اقترح أصغر خطوة أولى ممكنة، لا التغيير الكامل في البروتوكول.',
  'bias.authority_bias.name': 'تحيّز السلطة',
  'bias.authority_bias.cue': 'يعتمد الطبيب على قرار لجنة أو مؤسسة أو بروتوكول بدلاً من تكوين حكم مستقل على عرضك.',
  'bias.authority_bias.tactic': 'ابحث عن الشخصية المرجعية التي توافق بالفعل وابدأ بها — الدعم الداخلي أقوى من أي حجة خارجية.',
  'bias.negativity_bias.name': 'تحيّز السلبية',
  'bias.negativity_bias.cue': 'تجربة سيئة واحدة في التوصيل أو التوفر تلوّن نظرته للمنتج بأكمله، بشكل غير متناسب مع ندرة حدوثها.',
  'bias.negativity_bias.tactic': 'اذكر الخلل تحديدًا والحل الملموس له قبل العودة إلى مزايا المنتج — لا تتجاوز الموضوع بصمت.',
