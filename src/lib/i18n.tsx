...
const EN: Dict = {
  ...
  'privacy.body': 'Your AI doctor/colleague roleplay sessions save scores and metadata for your own history and manager coaching — never raw audio, which is discarded right after processing. You can permanently delete this history at any time.',
...
const AR: Dict = {
  ...
  'privacy.body': 'جلسات التدريب الصوتي مع الطبيب أو الزميل بالذكاء الاصطناعي تحفظ النتائج والبيانات الوصفية لسجلك الشخصي وتدريب مديرك — لا يُحفظ الصوت الخام أبداً، إذ يُحذف فور المعالجة. يمكنك حذف هذا السجل نهائياً في أي وقت.',
