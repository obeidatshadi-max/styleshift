...
const EN: Dict = {
  ...
  // L4
  'l4.title': 'The Boardroom',
  'l4.globalQuota': 'Global Quota',
  'l4.teamMorale': 'Team Morale',
  'l4.riskAssessment': 'Risk Assessment',
  'l4.balanced': 'Balanced move',
  'l4.offBalance': 'Off-balance',
  'l4.metersTag': ' <span style="color:var(--ink-dim)">[Quota {quota} · Morale {morale} · Risk {risk}]</span>',
  // result
  'result.subtitle': 'Level {level} accuracy · {got}/{total} optimal moves',
  'result.dealBalanced': 'Deal balanced',
  'result.dealUnbalanced': 'Deal unbalanced',
  'result.target': 'Target to clear: Quota ≥ 60, Morale ≥ 50, Risk ≤ 50.',
...
const AR: Dict = {
  ...
  'l4.title': 'غرفة المفاوضات',
  'l4.globalQuota': 'الحصة الكلية',
  'l4.teamMorale': 'المعنويات',
  'l4.riskAssessment': 'تقييم المخاطرة',
  'l4.balanced': 'تحرك متوازن',
  'l4.offBalance': 'اختلال في التوازن',
  'l4.metersTag': ' <span style="color:var(--ink-dim)">[الحصة {quota} · المعنويات {morale} · المخاطرة {risk}]</span>',
  'result.subtitle': 'دقة المستوى {level} · {got}/{total} قرار مثالي',
  'result.dealBalanced': 'صفقة متوازنة',
  'result.dealUnbalanced': 'صفقة مختلة',
  'result.target': 'المطلوب للنجاح: الحصة ≥ 60، المعنويات ≥ 50، المخاطرة ≤ 50.',
