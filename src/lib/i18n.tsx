...
const EN: Dict = {
  ...
  'login.otpSent': 'Code sent to {number}',
  'login.otpVerify': 'Verify & Sign In',
  'login.otpInvalid': 'Incorrect or expired code.',
  'login.otpChangeNumber': 'Use a different number',
...
const AR: Dict = {
  ...
  'login.mobileSignIn': 'إرسال الرمز',
  ...
  'login.otpPlaceholder': 'رمز مكوّن من 6 أرقام',
  'login.otpSent': 'تم إرسال الرمز إلى {number}',
  'login.otpVerify': 'تحقق ودخول',
  'login.otpInvalid': 'رمز غير صحيح أو منتهي الصلاحية.',
  'login.otpChangeNumber': 'استخدام رقم آخر',
